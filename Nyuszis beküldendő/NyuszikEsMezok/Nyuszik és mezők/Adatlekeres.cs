...
namespace Nyuszik_és_mezők
{
    ...
    {
        /// <summary>
        /// Kigenerálja a nyulakat úgy egy mátrixba, hogy százalékot megadva lehessen a gyakoriságot változtatni
        /// </summary>
        /// <param name="n">sor</param>
        /// <param name="m">oszlop</param>
        /// <param name="chance">Az esély amivel a nyúl megjelenik generáláskor</param>
        /// <returns></returns>
